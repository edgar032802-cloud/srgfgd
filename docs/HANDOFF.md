...
| 경로 | 내용 | 만든 방법 |
|---|---|---|
| `public/frames/f_001~131.jpg` | 히어로 영상 프레임 1440×810, 6.3MB | `아큐 테리 수정본.mp4` 에서 `ffmpeg -vf scale=1440:810:flags=lanczos -q:v 4` |
...
- 모바일 390px 완전 호환, 터치 타깃 44px, 가로 스크롤 금지.
